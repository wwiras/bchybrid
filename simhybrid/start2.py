...
def send_message_to_self(message, max_rounds):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rmax', type=int, required=True, help="Rmax value for the hybrid protocol.") # <-- ADDED
    args = parser.parse_args()
    send_message_to_self(args.message, args.rmax)