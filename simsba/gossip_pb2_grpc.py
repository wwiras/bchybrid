...
class GossipServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateNeighbors = channel.unary_unary(
                ...
                response_deserializer=gossip__pb2.Acknowledgment.FromString,
                _registered_method=True)
        self.NotifyPenalty = channel.unary_unary(
                '/gossip.GossipService/NotifyPenalty',
                request_serializer=gossip__pb2.PenaltyNotification.SerializeToString,
                response_deserializer=gossip__pb2.Acknowledgment.FromString,
                _registered_method=True)
...
class GossipServiceServicer(object):
    ...
    def NotifyPenalty(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_GossipServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'NotifyPenalty': grpc.unary_unary_rpc_method_handler(
                    servicer.NotifyPenalty,
                    request_deserializer=gossip__pb2.PenaltyNotification.FromString,
                    response_serializer=gossip__pb2.Acknowledgment.SerializeToString,
            ),
    }
...
class GossipService(object):
    ...
    def NotifyPenalty(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/gossip.GossipService/NotifyPenalty',
            gossip__pb2.PenaltyNotification.SerializeToString,
            gossip__pb2.Acknowledgment.FromString,
            options,
            channel_credentials,
            insecure,
